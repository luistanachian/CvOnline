...
namespace Cv.Repository.Interface
{
    public interface ICandidatesRepository
    {
        ...
        List<CandidateModel> GetBy(string companyId, LinesEnum lines, string name = null, StatusCandiateEnum? status = null, int? countryId = null, int? stateId = null);
        List<CandidateModel> GetBy(string companyId, LinesEnum lines, List<string> skills, StatusCandiateEnum? status = null, int? countryId = null, int? stateId = null);
